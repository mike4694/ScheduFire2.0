...
public class Util {
	...
	public static void isCapoTurno(HttpServletRequest request) throws AutenticazioneException {
		...
		if(!ruolo.equals("capoturno") && !ruolo.equals("caposquadra")  ) {
			request.getSession().invalidate();
			throw new AutenticazioneException(ruolo +" Devi essere capoturno per poter accedere a questa funzionalit&agrave;");
		}
	...
	//METOO CAPOSQUADRA
	public static void isCapoSquadra(HttpServletRequest request) throws AutenticazioneException {
		if(request.getSession(false)==null) {
			request.getSession().invalidate();
			throw new AutenticazioneException("Richiesta l'autenticazione per poter accedere alle funzionalit&agrave; del sito.");
		...
		if(!ruolo.equals("caposquadra")) {
			request.getSession().invalidate();
			throw new AutenticazioneException("Devi essere caposquadra per poter accedere a questa funzionalit&agrave;");
		}
		if(request.getSession().getAttribute("notifiche")==null) {
			request.getSession().invalidate();
			throw new AutenticazioneException("Richiesta l'autenticazione per poter accedere alle funzionalit&agrave; del sito.");
